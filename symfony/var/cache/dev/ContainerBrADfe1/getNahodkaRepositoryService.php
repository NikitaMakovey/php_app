...
// Returns the private 'App\Repository\NahodkaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NahodkaRepository.php';

return $this->privates['App\\Repository\\NahodkaRepository'] = new \App\Repository\NahodkaRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
