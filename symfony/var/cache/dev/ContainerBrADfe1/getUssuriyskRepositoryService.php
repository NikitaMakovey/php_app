...
// Returns the private 'App\Repository\UssuriyskRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UssuriyskRepository.php';

return $this->privates['App\\Repository\\UssuriyskRepository'] = new \App\Repository\UssuriyskRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
