...
// Returns the private 'App\Repository\ArtemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ArtemRepository.php';

return $this->privates['App\\Repository\\ArtemRepository'] = new \App\Repository\ArtemRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
