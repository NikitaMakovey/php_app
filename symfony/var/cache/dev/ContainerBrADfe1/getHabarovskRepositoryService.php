...
// Returns the private 'App\Repository\HabarovskRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HabarovskRepository.php';

return $this->privates['App\\Repository\\HabarovskRepository'] = new \App\Repository\HabarovskRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
