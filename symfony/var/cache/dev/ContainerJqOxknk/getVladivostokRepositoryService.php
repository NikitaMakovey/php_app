...
// Returns the private 'App\Repository\VladivostokRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VladivostokRepository.php';

return $this->privates['App\\Repository\\VladivostokRepository'] = new \App\Repository\VladivostokRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
