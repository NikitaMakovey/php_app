...
class CouponParserPostgres
{
     ...
     */
    public function getDb(): DatabasePostgres
    {
        return $this->db;
    }
     ...
     */
    public function setDb(DatabasePostgres $db): void
    {
        $this->db = $db;
    }
    ...
    public function __construct($city)
    {
        $city = lcfirst($city);
        $this->setCity($city);
        $db = new DatabasePostgres($this->getCity());
        $this->setDb($db);
        $this->setLink($city);
    }
